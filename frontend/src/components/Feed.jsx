...
function Feed() {
  ...
  return (
    <div className='lg:w-[50%] w-full bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white min-h-[100vh] lg:h-[100vh] relative lg:overflow-y-auto'>
      ...
      {/* Posts */}
      <div className='w-full min-h-[100vh] flex flex-col items-center gap-[20px] p-[10px] pt-[40px] bg-gradient-to-br from-[#2c3e50] to-[#4ca1af] text-white rounded-t-[60px] relative pb-[120px]'>
        <Nav/>
